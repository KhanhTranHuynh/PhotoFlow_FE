        ...
        <div className="flex justify-between items-center h-full">
          ...
          {menuType === "horizontal" && (
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              <Logo />
              {/* show horizontal menu next to logo on wide screens (left-aligned) */}
              {width >= breakpoints.xl && <HorizentalMenu />}
              {/* open mobile menu handlaer*/}
          ...
          {/* Nav Tools  */}
          <div className="nav-tools flex items-center lg:space-x-6 space-x-3 rtl:space-x-reverse p-2 bg-white rounded-lg">
            {/* <Language /> */}
            {/* <SwitchDark /> */}
            {/* <MonoChrome /> */}
