...
import AddKhachHangModal from "@/views/khach-hang/add";
import EditKhachHangModal from "@/views/khach-hang/edit";
import DeleteKhachHangModal from "@/views/khach-hang/delete";
...
const KhachHang = () => {
  const khachHang_view = usePermission("khachHang_view");
